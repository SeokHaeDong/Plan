...
public interface UserService {
    ...
    default User DTOToEntity(UserDTO dto){
        User user = User.builder().email(dto.getEmail()).id(dto.getId()).pw(dto.getPw()).nick(dto.getNick()).birthday(dto.getBirthday()).gender(dto.getGender())
    ...
    default UserDTO EntityToDTO(User user){
        UserDTO dto = UserDTO.builder().email(user.getEmail()).id(user.getId()).pw(user.getPw()).nick(user.getNick()).birthday(user.getBirthday()).gender(user.getGender())
